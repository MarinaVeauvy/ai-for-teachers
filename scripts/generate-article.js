...
const SITE_NAME = 'AI Teaching Tools';
const SITE_COLOR = '#f39c12';
const fs = require('fs');
...
const TOPICS = [
  ...
  "Best AI Grading and Assessment Tools for Educators",
  "AI Tools for Creating Educational Content and Presentations",
  "How Teachers Can Use AI to Differentiate Instruction",
  "Best AI Writing Feedback Tools for Student Essays",
  "AI-Powered Quiz and Test Generators for Teachers",
  "How to Use AI for Special Education and IEP Support",
  "Best AI Tools for Online and Hybrid Teaching",
  "AI Tutoring Tools: Can They Replace Human Tutors?",
  "How to Create Interactive Lessons with AI Tools",
  "Best AI Tools for Language Teachers and ESL Educators",
  "AI for School Administrators: Scheduling and Operations",
  "How to Use AI for Parent-Teacher Communication",
  "Best Free AI Tools Every Teacher Should Know About"
];
